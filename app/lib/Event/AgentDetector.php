    ...
    class AgentDetector {
        ...
        function browser_detection($which_test, $test_excludes = '') {
            ...
            */
            if (!$b_repeat) {
                ...
                */
                ...
                $a_browser_types = array(array('opera',
                                               true,
                                               'op',
                                               'bro'),
                                         array('msie',
                                         ...
                                         array('libwww-perl',
                                               ...
                                               'libwww-perl',
                                               'lib'),
                                         array('jakarta commons-httpclient',
                                               false,
                                               'jakarta',
                                               'lib'),
                                         array('python-urllib',
                ...
                */
                    ...
                    if (strstr($browser_user_agent, $s_browser)) {
                        ...
                        */
                        ...
                        switch ($browser_name) {
                            ...
                            case 'ns':
                                $safe_browser = false;
                                $browser_version_number = $this->get_item_version($browser_user_agent, 'mozilla');
                                break;
                            case 'moz':
                                /*
                                ...
                                */
                                ...
                                for ($j = 0; $j < $j_count; $j++) {
                                    if (strstr($browser_user_agent, $a_moz_types[$j])) {
                                        ...
                                        $moz_version_number = $this->get_item_version($browser_user_agent, $moz_type);
                                        break;
                                    }
                                }
                                /*
                            ...
                            case 'ie':
                                ...
                                */
                                $browser_version_number = $this->get_item_version($browser_user_agent, $s_browser, true, 'trident/');
                                ...
                                break;
                            case 'op':
                                $browser_version_number = $this->get_item_version($browser_user_agent, $s_browser);
                ...
                if ($b_os_test) {
                    $a_os_data = $this->get_os_data($browser_user_agent, $browser_name, $browser_version_number);
            ...
            */
            ...
            $a_moz_data = array($moz_type,
                                $moz_version_number,
                                $moz_rv,
                                $moz_rv_full,
                                $moz_release_date);
            $a_webkit_data = array($webkit_type,
                                   $webkit_type_number,
                                   $browser_version_number);
            ...
            switch ($which_test) {
                ...
                case 'full':// returns all relevant browser information in an array
                    $a_full_data = array($browser_name,
                                         $browser_version_number,
                                         $ie_version,
                                         $dom_browser,
                                         $safe_browser,
        ...
        function get_os_data($pv_browser_string, $pv_browser_name, $pv_version_number) {
            ...
            */
            $a_mac = array('intel mac',
                           'ppc mac',
                           'mac68k');// this is not used currently
            // same logic, check in order to catch the os's in order, last is always default item
            $a_unix_types = array('freebsd',
                                  'openbsd',
                                  'netbsd',
                                  'bsd',
                                  'unixware',
            ...
            $a_linux_distros = array('ubuntu',
                                     ...
                                     'sabayon',
                                     'linux');
            $a_linux_process = array('i386',
                                     'i586',
                                     'i686');// not use currently
            // note, order of os very important in os array, you will get failed ids if changed
            $a_os_types = array('android',
                                'blackberry',
                                'iphone',
                                'palmos',
                                'palmsource',
            ...
            */ elseif (is_array($os_working_data) && ($i == ($i_count - 1))) {
            ...
            $a_os_data = array($os_working_type,
                               $os_working_number);
        ...
        function get_item_version($pv_browser_user_agent, $pv_search_string, $pv_b_break_last = '', $pv_extra_search = '') {
            ...
            */
            for ($i = 0; $i < 4; $i++) {
                ...
                if (strpos((string) $pv_browser_user_agent, $pv_search_string, $start_pos) !== false) {
        ...
        */
        function get_mobile_data($pv_browser_user_agent) {
            ...
            $a_mobile_browser = array('avantgo',
                                      'blazer',
                                      'elaine',
                                      'eudoraweb',
                                      'iemobile',
            ...
            */
            ...
            for ($k = 0; $k < $k_count; $k++) {
                if (strstr($pv_browser_user_agent, $a_mobile_os[$k])) {
                    ...
                    // this may or may not work, highly unreliable
                    $mobile_os_number = $this->get_item_version($pv_browser_user_agent, $mobile_os);
                    break;
                }
            }
            ...
            for ($k = 0; $k < $k_count; $k++) {
                if (strstr($pv_browser_user_agent, $a_mobile_server[$k])) {
                    ...
                    // this may or may not work, highly unreliable
                    $mobile_server_number = $this->get_item_version($pv_browser_user_agent, $a_mobile_server);
                    break;
                }
            }
            ...
            $a_mobile_data = array($mobile_device,
                                   $mobile_browser,
                                   $mobile_browser_number,
                                   $mobile_os,
                                   $mobile_os_number,
