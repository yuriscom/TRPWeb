<?php
    ...
    class PropertyHybridHood extends Filter {
        ...
        public function match($path, \Router\Route\Route $route, \Router\Router $router) {
            ...
            $params = array('controller' => 'listview',
                            ...
                            'seoName' => 'property-listview-city-hood');
            ...
            foreach ($this->_mappingAr as $mCity => $hoods) {
                if ($mCity == $params['city'] && in_array($pathAr[1], $hoods)) {
                    $pattern = "/{province}-{city}/mls-listings-for-sale/";
            ...
            switch ($m2[1]) {
                ...
                default:
                    $params['type'] = $m2[1];
                    $params['seoName'] = 'property-listview-city-hood-type';
                    break;
            }
            ...
            switch (count($pathAr)) {
                case 2:
                    break;
                case 3:
                    //todo: send to hood profile page.
                    break;
                case 4:
        ...
        public function assemble(array $params) {
            ...
            $pattern = "/{province}-{city}/{hood}/mls-({ist}|listings)-for-sale(/{beds:[\"studio\",\"1\"]}-bedroom|/{beds}-bedrooms|/priced-between-{min_price}-{max_price}|/under-{max_price}|/over-{min_price})";
//            $pattern = "/{province}-{city}/{hood}/mls-({ist}|listings)-for-sale";
            $url = "";
            try {
