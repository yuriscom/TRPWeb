{% if listing['PropertyTrpType']['name'] == 'Apartment' or
		listing['PropertyTrpType']['name'] == 'Lofts' %}
...
<div class="row">
	<div class="small-12  medium-6 columns container">
		...
		<h2 class="extra-space h3" data-carousel-subtitle>{{ listing['PropertyTrpType']['name'] }} for sale in {% if listing['addr_hood'] is defined %}{{ listing['addr_hood'] }}, {% endif %}{{ listing['addr_city'] }}</h2>
		...
		{% if listing['property_status_id'] != 2 %}
			<div class="small-12 columns medium-vertical-margin small-vertical-margin">
				<a href="#"
                    ...
                    data-reveal-analytics='{ "ga_call": "send", "ga_event": "event", "ga_category": "Hard", "ga_action": "AddressFullHomeReport", "ga_label": "{{ gaLabel }}", "ga_value": "" }'
			...
			<div class="small-12 columns">
				...
				{% if propertyType == 'house' %}
					<li class="small-6 columns">
						...
						<strong>
							{% if listing['fronting'] is defined %}
								{{ listing['fronting'] }}
							{% else %}
								<i>Info not provided</i>
							{% endif %}
                ...
                <li class="small-6 columns">
                    ...
                    <strong>{{ listing['PropertyType']['name'] }}</strong>
                </li>
                <li class="small-6 columns">
                    <span><i class=""></i>Style</span>
                    <strong>{{ listing['PropertyStyle']['name'] }}</strong>
                </li>
                <li class="small-6 columns end">
                    <span><i class=""></i>MLS #</span>
                    <strong>{{ listing['mls_num'] }}</strong>
                </li>
			</div>
		</ul>
...
<div class="row">
    <div class="columns hide-for-small-only medium-12 medium-left">
    	<a class="chat" href="#">Abbreviations unclear? We can help. <i class="icon icon-comments-o"></i></a>
    </div>
</div>
