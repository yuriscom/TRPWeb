<section class="content-main content-search content-buy-new" data-landing-action="{{ landing_action }}">
	<div class="content active">
		<div class="content-main-flex">
			<div class="content-main-container">
				<div class="row">
					<div class="columns content-tagline">
						<h1>Find your new home or condo <br class="tablet-up-break" />with TheRedPin</h1>
					</div>
				</div>
				<form data-abide>
					<div class="row">
